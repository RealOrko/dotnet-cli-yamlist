...
fly -t local-dev set-pipeline -p simple-job-with-task -c ./pipeline.yml
fly -t local-dev unpause-pipeline -p simple-job-with-task
fly -t local-dev trigger-job -j simple-job-with-task/my-simple-job-with-task
